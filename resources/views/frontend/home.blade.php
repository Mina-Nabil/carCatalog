        ...
        <div role="tabpanel" class="tab-pane {{($i==0) ? 'active' : ''}}" id="type{{$type->id}}">
          ...
          <div class="col-list-3">
            <div class="recent-car-list">
              <div class="car-info-box"> <a href="{{url('car/' . $car->id)}}"><img style="height: 200px; object-fit: fill;" src="{{(isset($car->image)) ? asset( 'storage/'. $car->image ) : 'assets/images/600x380.jpg'}}" class="img-fluid"
                    alt="image"></a>
