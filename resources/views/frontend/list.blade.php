      ...
      <div class="col-md-12">
        <div class="listing_images">
          <div id="listing_images_slider" class="listing_images_slider">
            ...
            <div><img height="560px" src="{{($image->MOIM_URL) ? asset('storage/' . $image->MOIM_URL) : asset('assets/frontend/images/900x560.jpg')}}" alt="image"></div>
            @endforeach
          </div>
          <div id="listing_images_slider_nav" class="listing_images_slider_nav">
            @foreach($model->colorImages as $image)
            <div><img width="300px" src="{{($image->MOIM_URL) ? asset('storage/' . $image->MOIM_URL) : asset('assets/frontend/images/900x560.jpg')}}" alt="image"></div>
            @endforeach
          </div>
        </div>
      </div>
