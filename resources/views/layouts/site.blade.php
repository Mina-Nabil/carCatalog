      ...
      <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item">
            <img src="{{(isset($frontendData['Landing Image']['Slide Image 2'])) ? asset('storage/' . $frontendData['Landing Image']['Slide Image 2'] ) : asset('assets/frontend/images/1920x830.jpg')}}" alt="image" class="img-fluid" style="max-height: 730px; height:auto; width:100%">
            <div class="carousel-caption">
              <div class="banner_text text-center div_zindex white-text">
